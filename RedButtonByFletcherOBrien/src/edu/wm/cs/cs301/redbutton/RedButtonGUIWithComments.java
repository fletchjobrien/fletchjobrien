package edu.wm.cs.cs301.redbutton; // classes are organized in packages, this line gives the one for our class here
...
//
class RedButtonGUIWithComments extends JPanel {
	...
	public static void main(String[] args) {
		...
		if (0 < args.length && ("red".equals(args[0]) || "green".equals(args[0]))) {
			...
			RedButtonGUIWithComments gui = new RedButtonGUIWithComments() ;
			gui.setColor(args[0]) ;
	...
	public RedButtonGUIWithComments() {
