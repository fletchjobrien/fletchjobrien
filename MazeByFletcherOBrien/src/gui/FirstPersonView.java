...
public class FirstPersonView {
	...
	static final int greenWM = 1136448; //CONVERTED FROM HEX TO DECIMAL
	...
	private int getBackgroundColor(float percentToExit, boolean top) {
		return top? blend(yellowWM, goldWM, percentToExit) : 
			blend(14737632, greenWM, percentToExit);
	}
	...
	private int blend(int fstColor, int sndColor, double weightFstColor) {
		return mp.blend(fstColor, sndColor, weightFstColor);
	  }
	/**
